...
description: |
    ...
    + ausgestattet mit dem Truckstop Lenker und ExtraTerrestrial-Reifen für zuverlässiges Handling und reibungslosen Antrieb
    + Flat-Mount-Scheibenbremsen
    + die Rahmengrößen 42 – 56 sind mit Rädern mit einem Durchmesser von 559mm erhältlich, während die Rahmengrößen 56 – 64 mit Rädern mit einem Durchmesser von 622mm erhältlich sind
    + Tire Clearance für 54-559 / 47-622 mit oder ohne Schutzbleche


specs:
  - frametype: 'Diamant'
  - frame: '4130 CrMo, doppelt konifiziertes Rahmendreieck'
