...
import Modernizr from './modernizr-cssanimations.js';
...
Object.assign( SideMenu.prototype, {
    ...
    options: {
        // show breadcrumbs
        breadcrumbsCtrl: true, // initial breadcrumb text
        initialBreadcrumb: 'all', // show back button
        backCtrl: true, // delay between each menu item sliding animation
    ...
    _init(){
        ...
        // more specifically an array of objects where each one holds the info of each menu element and
        // its menu items
        this.menusArr = [];
    ...
    _menuOut( clickPosition ){
        // the current menu
        var self = this, currentMenu = this.menusArr[ this.current_menu ].menuEl,
    ...
    _menuIn( nextMenuEl, clickPosition ){
        var self = this, // the current menu
